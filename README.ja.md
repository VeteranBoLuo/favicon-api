...
<a href="https://boluo66.top/favimg/?url=github.com"><img src="https://img.shields.io/badge/🚀_ライブデモ-615ced?style=for-the-badge&logoColor=white" alt="demo"></a>
...
- 🎯 **リクエスト一つ** — `/?url=example.com` でアイコンを返却。裸のドメインには自動で `https://` を付与
...
ライブデモ: <https://boluo66.top/favimg/?url=github.com>
...
| `size` | 任意。希望サイズ(px)。ヒントとしてレスポンスヘッダーに書き戻し |
...
4. 結果をメモリにキャッシュ(LRU 上限 + 1h TTL)し、内容ハッシュ ETag で 304 再検証に対応
